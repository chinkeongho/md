...
- Keep a private, fast, and predictable Markdown workspace without plugins or cloud dependencies.
- Preserve the simplicity of a file-backed vault while adding just the features needed day-to-day.
...
- Backlinks section to navigate notes that reference the current note.
...
- **Viewing**: Render Markdown with standard syntax, tables, images, Mermaid diagrams, and backlinks. Rendering should be accurate to source (no Obsidian-only plugins); images (png/jpg/webp/gif/svg) should display inline.
