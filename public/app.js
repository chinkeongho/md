...
async function loadSettings() {
  try {
    ...
    els.settingsDailyDir.value = state.settings.dailyNotesDir || '';
    els.settingsDailyTemplate.value = state.settings.dailyNotesTemplate || '';
    els.settingsWeeklyDir.value = state.settings.weeklyNotesDir || '';
    els.settingsWeeklyTemplate.value = state.settings.weeklyNotesTemplate || '';
    els.settingsWeekStart.value = state.settings.weekStartsOn || 'monday';
    els.settingsSortOrder.value = state.settings.fileSortOrder || 'mtime_desc';
    els.settingsShortcutSave.value = state.settings.shortcutSave || 'Ctrl+S';
    els.settingsShortcutBack.value = state.settings.shortcutBack || 'Alt+ArrowLeft';
    els.settingsShortcutForward.value = state.settings.shortcutForward || 'Alt+ArrowRight';
    els.settingsShortcutLineUp.value = state.settings.shortcutLineUp || 'Alt+ArrowUp';
    els.settingsShortcutLineDown.value = state.settings.shortcutLineDown || 'Alt+ArrowDown';
    els.settingsShortcutMultiSelect.value = state.settings.shortcutMultiSelect || 'Ctrl+D';
    els.settingsShortcutMultiSelectAll.value = state.settings.shortcutMultiSelectAll || 'Ctrl+Shift+D';
    els.settingsShortcutToggle.value = state.settings.shortcutToggleSidebar || 'Alt+S';
    els.settingsTheme.value = state.settings.theme || 'light';
    els.settingsNoteTemplate.value = state.settings.noteTemplate || '';
    els.settingsSearchLimit.value = state.settings.searchLimit || 1000;
